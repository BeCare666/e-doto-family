    ...
    userRef.once("value")
      .then((snapshot) => {
        ...
        if (user) {
          ...
          var UserCOMMISSON = user.SOLDEAFILIATE
            ...
            IdTogetwallet.addEventListener('click', function(){
                ...
                Swal.fire({
                 ...
                 <tr>
                     ...
                     Nous avons le plaisir de vous informer que ${username} a récemment retiré ${UserCOMMISSON} de son portefeuille. Nous vous prions de bien vouloir confirmer cette transaction. 
                     </p>
                     <ul>
